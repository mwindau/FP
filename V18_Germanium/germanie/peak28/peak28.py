...
a = np.arange(6082, 6089)
b = np.genfromtxt('peak28.txt')

x_plot = np.linspace(6082, 6088, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[5, 6085, 0.5])
