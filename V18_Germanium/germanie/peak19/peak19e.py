...
a = np.arange(1955, 1960)
b = np.genfromtxt('peak19e.txt')

x_plot = np.linspace(1955, 1959, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[60, 1958, 0.5])
