...
a = np.arange(5258, 5263)
b = np.genfromtxt('peak26.txt')

x_plot = np.linspace(5258, 5262, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[8, 5260, 0.5])
