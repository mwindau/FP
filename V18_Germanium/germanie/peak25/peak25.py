...
a = np.arange(4590, 4596)
b = np.genfromtxt('peak25.txt')

x_plot = np.linspace(4590, 4595, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[24, 4593, 0.5])
