...
a = np.arange(4294, 4302)
b = np.genfromtxt('peak10e.txt')

x_plot = np.linspace(4294, 4301, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[29, 4297, 0.5])
