...
a = np.arange(1910, 1917)
b = np.genfromtxt('peak6e.txt')

x_plot = np.linspace(1910, 1916, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[182, 1913, 0.5])
