...
a = np.arange(3499, 3506)
b = np.genfromtxt('peak22.txt')

x_plot = np.linspace(3499, 3505, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[30, 3503, 0.5])
