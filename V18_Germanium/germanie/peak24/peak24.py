...
a = np.arange(3752, 3757)
b = np.genfromtxt('peak24.txt')

x_plot = np.linspace(3752, 3756, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[39, 3754, 0.5])
