...
a = np.arange(2782, 2792)
b = np.genfromtxt('peak7e.txt')

x_plot = np.linspace(2782, 2791, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[249, 2787, 0.5])
