...
a = np.arange(6498, 6502)
b = np.genfromtxt('peak29.txt')

x_plot = np.linspace(6498, 6501, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[5, 6500, 0.5])
