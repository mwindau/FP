...
a = np.arange(1512, 1526)
b = np.genfromtxt('peak5e.txt')

x_plot = np.linspace(1512, 1525, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[1839, 1519, 0.5])
