...
a = np.arange(4379, 4394)
b = np.genfromtxt('peak11e.txt')

x_plot = np.linspace(4379, 4393, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[113, 4386, 0.5])
