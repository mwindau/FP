...
a = np.arange(5475, 5479)
b = np.genfromtxt('peak13e.txt')

x_plot = np.linspace(5475, 5478, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[34, 5476, 0.5])
