...
a = np.arange(3424, 3430)
b = np.genfromtxt('peak9e.txt')

x_plot = np.linspace(3424, 3429, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[64, 3427, 0.5])
