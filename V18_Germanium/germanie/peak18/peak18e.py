...
a = np.arange(1655, 1663)
b = np.genfromtxt('peak18e.txt')

x_plot = np.linspace(1655, 1662, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[75, 1659, 0.5])
