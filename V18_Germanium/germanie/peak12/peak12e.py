...
a = np.arange(4589, 4597)
b = np.genfromtxt('peak12e.txt')

x_plot = np.linspace(4589, 4596, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[19, 4591, 0.5])
