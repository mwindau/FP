...
a = np.arange(2322, 2327)
b = np.genfromtxt('peak20.txt')

x_plot = np.linspace(2322, 2326, 10000)

plt.plot(a, b, 'r.', label='Messdaten')


params, covariance_matrix = curve_fit(gauss, a, b, p0=[93, 2324, 0.5])
